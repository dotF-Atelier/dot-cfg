...
(def-doom-theme my-doom-horizon
  ...
  ((bg         '("#1f1f1f" nil       nil            ))
   ...
   (base1      '("#242424" "#111111" "brightblack"  ))
   (base2      '("#1d1f27" "#333333" "brightblack"  ))
   (base3      '("#1f1f1f" "#555555" "white"        ))
   ...
   (grey       base4)
   (red        '("#f97874" "#f97874" "red"          ))
   (orange     '("#f09383" "#f09383" "brightred"    ))
   (green      '("#abcdef" "#abcdef" "green"        ))
   (teal       '("#9491a3" "#9491a3" "brightgreen"  ))
   (yellow     '("#fab795" "#fab795" "yellow"       ))
   (blue       '("#ab9b96" "#ab9b96" "brightblue"   ))
   (dark-blue  '("#25b2bc" "#25b2bc" "blue"         ))
   (magenta    '("#6c6f93" "#6c6f93" "magenta"      ))
   (violet     '("#ab9b96" "#ab9b96" "brightmagenta"))
   (cyan       '("#ab9b96" "#ab9b96" "brightcyan"   ))
   (dark-cyan  '("#3bebab" "#3bebab" "cyan"   ))
